...
const Index = () => {
    ...
    const features = [
        {
            icon: GitBranch,
            title: t("learn.git.title"),
            desc: t("learn.git.desc"),
        },
        {
            icon: Terminal,
            title: t("learn.linux.title"),
            desc: t("learn.linux.desc"),
        },
        {
            icon: Wrench,
            title: t("learn.build.title"),
            desc: t("learn.build.desc"),
        },
            ...
            <section className="py-20 md:py-28 px-4">
                <div className="container mx-auto text-center max-w-3xl">
                    ...
                    >
                        <Link
                            to="/courses"
                            className="brutal-btn bg-primary text-primary-foreground text-base"
                        >
                            {t("hero.browse")}
                        </Link>
                        <Link
                            to="/contact"
                            className="brutal-btn bg-card text-foreground text-base"
                        >
                            {t("hero.join")}
                        </Link>
                    </motion.div>
            ...
            <section className="py-16 px-4">
                <div className="container mx-auto max-w-2xl">
                    <div className="brutal-card bg-primary text-primary-foreground p-10 text-center">
                        ...
                        <Link
                            to="/courses"
                            className="brutal-btn bg-secondary text-secondary-foreground text-base inline-block"
                        >
                            {t("cta.button")}
                        </Link>
                    </div>
